...
function AutoBarCategory:Initialize()
	...
	AutoBarCategoryList["Muffin.Food.Health.Basic"] = AutoBarItems:new( "Muffin.Food.Health.Basic", "INV_Misc_Food_23", "Muffin.Food.Health.Basic","Muffin.Food.Health.Conjured")
...
--		"SHAMAN", ABGCode:GetSpellNameByName("Feral Spirit"),
	...
	AutoBarCategoryList["Spell.Shields"] = AutoBarSpells:new( "Spell.Shields", spellIconList["Ice Barrier"], nil,
	{
		...
		"MAGE", 		ABGCode:GetSpellNameByName("Fire Ward"), ABGCode:GetSpellNameByName("Frost Ward"), 
		"MAGE",			ABGCode:GetSpellNameByName("Frost Ward"), ABGCode:GetSpellNameByName("Fire Ward"),
		"MAGE", 		ABGCode:GetSpellNameByName("Ice Armor"), ABGCode:GetSpellNameByName("Frost Armor"),
		"MAGE", 		ABGCode:GetSpellNameByName("Mage Armor"), ABGCode:GetSpellNameByName("Ice Armor"),
		"MAGE",			ABGCode:GetSpellNameByName("Mana Shield"), ABGCode:GetSpellNameByName("Ice Barrier"),
		"MAGE",			ABGCode:GetSpellNameByName("Ice Barrier"), ABGCode:GetSpellNameByName("Mana Shield"),
